  ...
  if (wpcf7Forms.length) {
    ...
    try {
      var _loop = function _loop() {
        ...
        var bot_fingerprint_key = $(wpcf7Form)[0].querySelector('form > div input[name=' + cf7a_prefix + 'bot_fingerprint]');
        ...
        var bot_fingerprint_extra = $(wpcf7Form)[0].querySelector('form > div input[name=' + cf7a_prefix + 'bot_fingerprint_extras]');
        ...
        if (bot_fingerprint_extra) {
          ...
          var activity = $(wpcf7Form)[0].querySelector('form > div input[name=' + cf7a_prefix + 'activity]');
          ...
          }, true); // detect the mouse/touch direction change OR touchscreen iterations
