...
require_once CF7ANTISPAM_PLUGIN_DIR . '/libs/b8/degenerator/standard.php';
require_once CF7ANTISPAM_PLUGIN_DIR . '/libs/b8/lexer/standard.php';
require_once CF7ANTISPAM_PLUGIN_DIR . '/libs/b8/storage/storage_base.php';
require_once CF7ANTISPAM_PLUGIN_DIR . '/libs/b8/storage/mysql.php';
...
class b8 {
	...
	function __construct( array $config = array(),
						 array $config_storage = array(),
						 array $config_lexer = array(),
						 array $config_degenerator = array() ) {
	...
	public function learn( string $text = null, string $category = null ) {
		...
		return $this->process_text( $text, $category, b8::LEARN );
	}
	...
	public function unlearn( string $text = null, string $category = null ) {
		...
		return $this->process_text( $text, $category, b8::UNLEARN );
	}
