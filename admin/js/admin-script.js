...
window.onload = function () {
  if (document.body.classList.contains('cf7-antispam-admin') || document.body.classList.contains('flamingo_page_flamingo_inbound')) {
    ...
    var alertMessage = cf7a_admin_settings.alertMessage; // the confirmation alert script
  ...
  if (document.body.classList.contains('cf7-antispam-admin')) {
    ...
    var welcomePanelCloseBtn = welcomePanel.querySelector('a.welcome-panel-close');
    welcomePanelCloseBtn.addEventListener('click', function (event) {
