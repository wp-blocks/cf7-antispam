...
/***/ "./admin/src/dashboard/dashboard.js":
/*!******************************************!*\
  !*** ./admin/src/dashboard/dashboard.js ***!
  \******************************************/
...
function spamCharts() {
  if (typeof spamChartData !== 'undefined') {
    ...
    cf7aCharts.lineChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById('line-chart'), lineConfig);
    cf7aCharts.pieChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById('pie-chart'), PieConfig);
    return cf7aCharts;
  }
}
...
/***/ "./admin/src/settings/settings.js":
/*!****************************************!*\
  !*** ./admin/src/settings/settings.js ***!
  \****************************************/
/***/ (function() {
...
window.onload = function () {
  ...
  if (document.body.classList.contains('cf7-antispam-admin') || document.body.classList.contains('flamingo_page_flamingo_inbound')) {
    var confirmationAlert = function confirmationAlert(e, message) {
      // eslint-disable-next-line no-alert,no-undef
      if (confirm(message || alertMessage)) window.location.href = e.dataset.href;
    };
    // eslint-disable-next-line
    var alertMessage = cf7a_admin_settings.alertMessage;

    // the confirmation alert script
    var alerts = document.querySelectorAll('.cf7a_alert');
  ...
  if (document.body.classList.contains('cf7-antispam-admin')) {
    ...
    var showAdvanced = function showAdvanced() {
      var advancedCheckbox = document.getElementById('enable_advanced_settings');
      var AdvSettingsCard = document.getElementById('advanced-setting-card');
      var AdvSettingsTitle = document.querySelectorAll('#cf7a_settings h2');
      var AdvSettingsTitleEl = AdvSettingsTitle[AdvSettingsTitle.length - 1];
      var AdvSettingsTxt = document.querySelectorAll('#cf7a_settings p');
      var AdvSettingsTxtEl = AdvSettingsTxt[AdvSettingsTxt.length - 2];
      var AdvSettingsForm = document.querySelectorAll('#cf7a_settings table');
      var AdvSettingsFormEl = AdvSettingsForm[AdvSettingsForm.length - 1];
...
/***/ "./admin/src/dashboard/dashboard.scss":
/*!********************************************!*\
  !*** ./admin/src/dashboard/dashboard.scss ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./admin/src/settings/settings.scss":
/*!******************************************!*\
  !*** ./admin/src/settings/settings.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/*!************************************!*\
  !*** ./admin/src/admin-scripts.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dashboard_dashboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard/dashboard */ "./admin/src/dashboard/dashboard.js");
/* harmony import */ var _dashboard_dashboard_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard/dashboard.scss */ "./admin/src/dashboard/dashboard.scss");
/* harmony import */ var _settings_settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings/settings.js */ "./admin/src/settings/settings.js");
/* harmony import */ var _settings_settings_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_settings_settings_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _settings_settings_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./settings/settings.scss */ "./admin/src/settings/settings.scss");
