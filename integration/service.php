...
class WPCF7_Antispam extends GlobalWPCF7_Service {
	...
	public function display( $action = '' ) {
		...
		if(isset($_POST['activate_antispam']) /*&&  $_POST['activate_antispam'] == 'submit'*/) {
			...
			echo '<button class="button" type="submit" value="submit" name="activate_antispam">Submit</button>';
			echo '</form>';
